...
<template>
    <div id="canvas">
        <TresCanvas>
            ...
            />
            <Line2 v-if="axisVector.x !== 0 || axisVector.y !== 0 || axisVector.z !== 0"
                :points="[new Vector3(0, 0, 0), new Vector3().copy(rotatedVector).applyQuaternion(inputQuaternion)]" 
            ...
            />
            <Line2
                :points="[new Vector3(0, 0, 0), axisProjectionVector]"
                :line-width="GUIDELINE_WIDTH"
                color="grey"
            />
            <Line2
                :points="[axisProjectionVector, axisVector]"
                :line-width="GUIDELINE_WIDTH"
                color="grey"
            />
